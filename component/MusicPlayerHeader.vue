<template>
    <div>
        <div className="vpmc:flex vpmc:items-center vpmc:justify-between vpmc:p-6 vpmc:pb-2">
            <button @click="toggleView" :class="buttonClass">
            ...
            <button @click="closePlayer"
                class="vpmc:rounded-full vpmc:p-2 vpmc:text-slate-300 vpmc:hover:bg-rose-50 vpmc:hover:text-rose-500 vpmc:transition-all">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                    stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    <path d="M18 6 6 18" />
                    <path d="m6 6 12 12" />
